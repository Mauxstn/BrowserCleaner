...
::  Lumina Cleaner
::  by Maurice - v3.2
::  https://github.com/Mauxstn/lumina-cleaner
:: ==================================
...
curl -s -o "%TEMP%\latest_version.txt" https://raw.githubusercontent.com/Mauxstn/lumina-cleaner/main/version.txt 2>nul
if not exist "%TEMP%\latest_version.txt" (
    curl -s -o "%TEMP%\latest_version.txt" https://raw.githubusercontent.com/Mauxstn/lumina-cleaner/master/version.txt 2>nul
)
if %errorlevel% neq 0 (
    endlocal & exit /b 0
)
...
curl -s -o "%TEMP%\LuminaCleaner_new.bat" https://raw.githubusercontent.com/Mauxstn/lumina-cleaner/main/BrowerCleaner.bat 2>nul
if not exist "%TEMP%\LuminaCleaner_new.bat" (
    curl -s -o "%TEMP%\LuminaCleaner_new.bat" https://raw.githubusercontent.com/Mauxstn/lumina-cleaner/master/BrowserCleaner.bat 2>nul
)
if %errorlevel% neq 0 (
